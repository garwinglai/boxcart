...
export default async function handler(req, res) {
  ...
  if (method === "POST") {
    ...
    for (let i = 0; i < images.length; i++) {
      ...
      const destFileName = `account/${subdomain}/digital-products/${fireStorageId}/productImages/${fileName}`;
      const srcFileName = `account/${subdomain}/digital-products/${oldStorageId}/productImages/${fileName}`;
