...
import { updateDigitalProductVisibility } from "@/helper/server/prisma/inventory/product-schema";
...
export default async function handler(req, res) {
  ...
  if (method === "POST") {
    ...
    const { success, value, error } = await updateDigitalProductVisibility(
      idInt,
      visibility
    );
