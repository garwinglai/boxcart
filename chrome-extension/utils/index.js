...
export function getUserCurrentLocation(positionCallback) {
  if ("geolocation" in navigator) {
    ...
    navigator.geolocation.getCurrentPosition(
      function (position) {
        ...
        positionCallback({ userLat, userLng });
      },
      function (error) {
        // Handle any errors that occurred while getting the user's location
